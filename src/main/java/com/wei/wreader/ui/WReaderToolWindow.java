...
public class WReaderToolWindow {
    ...
    private ReaderOrchestrator orchestrator;
    //endregion
    //endregion
    ...
    public WReaderToolWindow(ToolWindow toolWindow) {
        ...
        orchestrator = new ReaderOrchestrator(toolWindow.getProject());
    ...
    public void initContentTextArea(ToolWindow toolWindow) {
        ...
        contentTextPane.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent mouseEvent) {
                int pos = orchestrator.getClickedPosition(contentTextPane, mouseEvent);
                if (pos == -1) {
                    return;
                }

                // 获取点击位置处的HTML标签
                String htmlTag = orchestrator.getHTMLTagAtPosition(contentTextPane, pos);
