...
public class Settings {
    ...
    //--------------------------------------------
    /**
     * TTS引擎类型：edge - Edge TTS, mimo - MiMo TTS
     */
    ...
    /**
     * MiMo TTS 模型类型：mimo-v2.5-tts（预置音色）, mimo-v2.5-tts-voicedesign（文本描述音色）
     */
    private String mimoModelType;
    /**
     * MiMo TTS 音色描述（用于 VoiceDesign 模型）
     */
    private String mimoVoiceDescription;
    /**
     * 音色
     */
    ...
    public void setMimoApiKey(String mimoApiKey) {
        this.mimoApiKey = mimoApiKey;
    }

    public String getMimoModelType() {
        return mimoModelType;
    }

    public void setMimoModelType(String mimoModelType) {
        this.mimoModelType = mimoModelType;
    }

    public String getMimoVoiceDescription() {
        return mimoVoiceDescription;
    }

    public void setMimoVoiceDescription(String mimoVoiceDescription) {
