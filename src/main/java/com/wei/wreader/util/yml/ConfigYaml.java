package com.wei.wreader.util.yml;
...
public class ConfigYaml {
    ...
    private static volatile ConfigYaml instance;
    private static volatile ConfigYamlPojo configYamlPojo;
    ...
    public ConfigYaml() {
        try {
            ...
            try (InputStream is = ConfigYaml.class.getClassLoader().getResourceAsStream(CONFIG_FILE_PATH)) {
            ...
            System.err.println(ConstUtil.WREADER_CONFIG_LOAD_FAIL + ": " + e.getMessage());
    ...
    public static String getValue(String name) {
        ...
        Object result = getObjectStatic(name);
        return result != null ? result.toString() : null;
    }

    private static Object getObjectStatic(String name) {
