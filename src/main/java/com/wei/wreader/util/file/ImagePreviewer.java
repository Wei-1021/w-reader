package com.wei.wreader.util.file;
...
public class ImagePreviewer {
    private static final Logger LOG = Logger.getInstance(ImagePreviewer.class);
    ...
    public ImagePreviewer(Project project, String imagePath) {
        ...
        try {
            ...
            LOG.warn("Failed to load image: " + imagePath, e);
        }
    }
    ...
    public ImagePreviewer(Project project, File file) {
        ...
        try {
            ...
            LOG.warn("Failed to load image from file", e);
        }
    }
