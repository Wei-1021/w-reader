...
public class ConstUtil {
    ...
    public static final String WREADER_SEARCH_BOOK_TIP_TEXT = "请输入关键字搜索";
    public static final String WREADER_SEARCH_BOOK_SITE_TITLE = "选择书源";;
    ...
    /**
     * CssSelector自定义规则标志--@front
     */
    public static final String CSS_QUERY_FRONT_FLAG = "front:";
    /**
