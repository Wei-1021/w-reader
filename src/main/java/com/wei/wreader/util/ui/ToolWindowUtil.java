package com.wei.wreader.util.ui;
...
public class ToolWindowUtil {
    ...
    public static void registerCompatibleToolWindow(Project project,
        ...
        // 新版注册方式 (IDEA 2022.2+)
            ...
            // 检查是否已注册，避免重复注册导致异常
            ToolWindow existingWindow = toolWindowManager.getToolWindow(ConstUtil.WREADER_TOOL_WINDOW_ID);
            if (existingWindow != null) {
                existingWindow.setAvailable(true, null);
                existingWindow.activate(null);
                return;
            }
