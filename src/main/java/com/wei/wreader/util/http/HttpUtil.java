...
public class HttpUtil {
        ...
        if (POST.equalsIgnoreCase(requestMethod)) {
            ...
            if (bodyParam != null && !bodyParam.isEmpty()) {
                ...
                try {
                    ...
                    LOG.warn("Failed to encode form params", e);
                }
            }
    ...
    public static Document requestHtml(String url, String method, Map<String, String> queryParams,
                                       Map<String, String> bodyParams, Map<String, String> headers) throws IOException {
        ...
        for (int attempt = 1; attempt <= maxRetries; attempt++) {
            try {
                ...
                // 如果是最后一次尝试或非网络异常，抛出IOException
                throw new IOException("网络请求异常 (" + attempt + "/" + maxRetries + "): " +
                        e.getMessage() + "\n请检查网络连接或稍后重试！", e);
            }
        }
