...
public class WReaderStatusBarWidget extends EditorBasedStatusBarPopup {
    ...
    private static ReaderOrchestrator sharedOrchestrator;
    private static Project sharedProject;

    private static ReaderOrchestrator getOrCreateOrchestrator(Project project) {
        if (sharedOrchestrator == null || !project.equals(sharedProject)) {
            sharedOrchestrator = new ReaderOrchestrator(project);
    ...
    public static void prevChapter(@NotNull Project project) {
        ...
        // 获取上一章
        ReaderOrchestrator orchestrator = getOrCreateOrchestrator(project);
